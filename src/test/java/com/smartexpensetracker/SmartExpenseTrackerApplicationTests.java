...
class SmartExpenseTrackerApplicationTests {
    ...
    void testDtoCoverage() {
        ...
        com.smartexpensetracker.api.dto.RegisterRequest req2 = com.smartexpensetracker.api.dto.RegisterRequest.builder()
        ...
        com.smartexpensetracker.api.dto.RegisterRequest req3 = new com.smartexpensetracker.api.dto.RegisterRequest("F",
                "L", "U", "P");
